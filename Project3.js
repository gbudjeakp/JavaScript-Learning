...
class Elevator {
  ...
  moveOneFloor () {
    ...
    setTimeout(() => {
      const destination = thisElement.getDestination()
...
class Building {
  ...
  callElevator (origin, destination) {
    ...
    const elevator = this.getNearPossibleElevator(origin, destination)
  ...
  getNearPossibleElevator (origin, destination) {
    ...
    this.elevators.forEach(elevator => {
      ...
      const elevatorDiff = Math.abs(elevator.currentFloor - origin)
